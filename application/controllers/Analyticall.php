...
class Analyticall extends MY_Controller {
...
if($data['optionchart']=='2'){
$list = $this->analyticallexcel_model->Getcustomergroupproduct($data);
}else if($data['optionchart']=='3'){
$list = $this->analyticallexcel_model->Getcustomerlevelproduct($data);
}else if($data['optionchart']=='4'){
$list = $this->analyticallexcel_model->Getcustomersexproduct($data);
}else if($data['optionchart']=='5'){
$list = $this->analyticallexcel_model->Getcontactfromproduct($data);
}else if($data['optionchart']=='6'){
$list = $this->analyticallexcel_model->Getcontactgradeproduct($data);
}else if($data['optionchart']=='7'){
$list = $this->analyticallexcel_model->Getreasonbuyproduct($data);
}else if($data['optionchart']=='8'){
$list = $this->analyticallexcel_model->Getreasonnotbuyproduct($data);
}else if($data['optionchart']=='9'){
$list = $this->analyticallexcel_model->Getprovinceproduct($data);
}else if($data['optionchart']=='10'){
$list = $this->analyticallexcel_model->Getamphurproduct($data);
}else if($data['optionchart']=='11'){
$list = $this->analyticallexcel_model->Getdistrictproduct($data);
}else{
	$list = 'null';
}	
...
if($data['optionchart']=='7'){
$list = $this->analyticallexcel_model->Getreasonbuycontact($data);
}else if($data['optionchart']=='8'){
$list = $this->analyticallexcel_model->Getreasonnotbuycontact($data);
}else{
	$list = 'null';
}	
