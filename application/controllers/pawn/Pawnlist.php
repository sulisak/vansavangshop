...
class Pawnlist extends MY_Controller {
...
$data['tab'] = 'pawnlist';
$data['title'] = 'Pawn List';
		$this->pawnlayout('pawn/pawnlist',$data);
}
...
echo  $this->pawnlist_model->Getenddate($data);
...
$success = $this->pawnlist_model->Delete($data);
 ...
 function Pawnadddatelist()
    {
 $data = json_decode(file_get_contents("php://input"),true);
if(!isset($data)){
exit();
}
		$success = $this->pawnlist_model->Pawnadddatelist($data);
 ...
 function Pawnadddatedel()
    {
 $data = json_decode(file_get_contents("php://input"),true);
if(!isset($data)){
exit();
}
		$success = $this->pawnlist_model->Pawnadddatedel($data);
...
function Pawnresetconfirm()
    {
 $data = json_decode(file_get_contents("php://input"),true);
if(!isset($data)){
exit();
}
		$success = $this->pawnlist_model->Pawnresetconfirm($data);
...
function Pawngosaleconfirm()
    {
 $data = json_decode(file_get_contents("php://input"),true);
if(!isset($data)){
exit();
}
		$success = $this->pawnlist_model->Pawngosaleconfirm($data);
