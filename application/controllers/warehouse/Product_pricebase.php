...
class Product_pricebase extends MY_Controller {
...
$data['tab'] = 'product_pricebase';
$data['title'] = 'Product PriceBase';
		$this->deshboardlayout('warehouse/product_pricebase',$data);
}
...
if(!isset($_POST['product_code']) || $_POST['product_code']==''){
$data['product_code'] = rand(1000,9999);
}else{
...
$data['product_stock_num'] = '';
	...
	$data['product_stock_num'] = $dataexcel[4];
}
