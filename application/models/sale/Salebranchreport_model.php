...
class Salebranchreport_model extends CI_Model {
...
$query = $this->db->query('SELECT sh.branch_id,
b.branch_name,
...
LEFT JOIN branch as b on b.branch_id=sh.branch_id
WHERE sd.adddate BETWEEN "'.$dayfrom.'" AND "'.$dayto.'" AND b.branch_id="'.$data['branch_id'].'"
ORDER BY sd.ID DESC');
...
$query = $this->db->query('SELECT
    cus_name as "ຊື່ລູກຄ້າ",
	sumsale_num as "ລວມຈຳນວນທີ່ຊື້",
	sumsale_price as "ລວມຍອດເງິນທີ່ຊື້",
	from_unixtime(adddate,"%d-%m-%Y %H:%i:%s") as "ວັນທີ"
