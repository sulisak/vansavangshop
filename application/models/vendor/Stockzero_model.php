...
$querynum = $this->db->query('SELECT
    ...
    WHERE wl.owner_id="'.$_SESSION['owner_id'].'" AND wl.supplier_id="'.$_SESSION['supplier_id'].'" AND wl.product_stock_num < "1"   AND wl.product_code LIKE "%'.$data['searchtext'].'%"
    OR wl.owner_id="'.$_SESSION['owner_id'].'" AND wl.supplier_id="'.$_SESSION['supplier_id'].'" AND wl.product_stock_num < "1" AND wl.product_name LIKE "%'.$data['searchtext'].'%"
    OR wl.owner_id="'.$_SESSION['owner_id'].'" AND wl.supplier_id="'.$_SESSION['supplier_id'].'" AND wl.product_stock_num < "1" AND z.zone_name LIKE "%'.$data['searchtext'].'%"
