...
$query = $this->db->query('SELECT cat_rank,product_category_id,product_category_name 
FROM wh_product_category WHERE owner_id="'.$_SESSION['owner_id'].'" 
ORDER BY cat_rank ASC, product_category_id DESC');
