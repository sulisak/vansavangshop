...
class Reportinstock_model extends CI_Model {
...
$query = $this->db->query('SELECT *,
  ...
  (SELECT sum(importproduct_detail_num) FROM wh_importproduct_detail as wu WHERE wu.product_id=sh.product_id AND wu.importproduct_detail_date BETWEEN "'.$dayfrom.'" AND "'.$dayto.'") AS product_in_num
