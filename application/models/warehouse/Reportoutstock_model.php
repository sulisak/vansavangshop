...
$query = $this->db->query('SELECT *,
  ...
  (SELECT sum(product_sale_num) FROM 	sale_list_detail as wu WHERE wu.product_id=sh.product_id AND wu.adddate BETWEEN "'.$dayfrom.'" AND "'.$dayto.'") AS product_saleout_num,
