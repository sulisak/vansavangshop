...
<?=$lang_search?> <?php echo $lang_barcode;?>" ng-change="getlist(searchtext,'1')">
</div>
...
<th class="text-center"><?php echo $lang_ldod_1;?></th>
			...
			<th class="text-center"><?php echo $lang_ldod_2;?></th>
			<th class="text-center"><?php echo $lang_shift;?></th>
<th class="text-center"><?php echo $lang_ldod_3;?></th>
