...
<center>
			<span ng-if="pay_type!='4'" style="font-size: 35px;font-weight: bold;">ใบเสร็จรับเงิน/ใบส่งสินค้า</span>
...
<table class="table table-hover table-bordered">
	...
	<tbody>
		...
		<tr>
			<td colspan="6"  align="right" style="font-weight: bold;"><?=$lang_all?></td>
...
<td align="right" colspan="6"><?=$lang_vat?> {{vat3}} %</td>
		...
		<!-- <tr ng-if="vat3=='0'">
		<td align="right" colspan="6">VAT 7%</td>
		<td style="font-weight: bold;" align="right">
		{{sumsalevat-((sumsalevat*100)/107) | number:2}}</td>
		</tr>

		<tr ng-if="vat3=='0'">
		<td align="right" colspan="6">ยอดก่อนรวม VAT</td>
		<td style="font-weight: bold;" align="right">
		{{(sumsalevat*100)/107 | number:2}}</td>
		</tr> -->
...
<div class="modal fade" id="Openonesend">
	...
	<select ng-model="lung" ng-change="Selectlung(lung)" class="form-control" style="font-size: 20px;text-align: center;height: 40px;">
		<option value="1">
			เลือกใบปะหน้ากล่องใหญ่ กระดาษ A4
		</option>
		<option value="2">
			เลือกใบปะหน้ากล่องเล็ก
		</option>
	</select>
	<button class="btn btn-primary" ng-click="printDiv()"><?=$lang_print?></button>
			<div class="modal-body" id="section-to-print2">
...
<table ng-if="lung=='2'" class="table table-bordered" style="table-layout: fixed;">
	<tr>
<td>
	<span style="font-size: 30px;"> ผู้ส่ง </span>
...
<td>
			<span style="font-size: 30px;">	ผู้รับ </span>
			<br />
	<span style="font-size: 20px;">
<b>{{dataprintsend.cus_name}}</b>
	<br />
ที่อยู่: {{dataprintsend.cus_address_all}}	
...
<td align="center" style="height: 500px;">
	<span style="font-size: 50px;"> ผู้ส่ง </span>
...
<tr>
			<td align="center" style="height: 500px;">
			<span style="font-size: 60px;">	ผู้รับ </span>
			<br />
...
$scope.Savesale = function(changemoney,sumsalepricevat,discount_last){
	...
	if(isNaN($scope.money_from_customer) == true ){
toastr.warning('<?=$lang_getmoneynumberplz?>');
} else if($scope.listsale == '' || $scope.listsale[0].product_id=='0' ){
