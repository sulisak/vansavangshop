...
<div class="form-group" style="float: left;">
<button ng-click="Opencourse()" class="btn btn-success btn-lg" 
...
<?php }else{ ?>
class="col-xs-2 col-sm-2 col-md-2 panel panel-default product_box product_box_button"
<?php } ?>
ng-repeat="x in productlist"  title="{{x.product_name}} {{x.product_des}}" style="height: 220px;cursor: pointer;padding-left: 0px;padding-right: 0px;" ng-click="Addpushproductcode(x.product_code)">
...
<?php } ?>				
				...
				<?php if(isset($_SESSION['shift_user_id']) && $_SESSION['user_id']==$_SESSION['shift_user_id']){?>
					<button ng-click="Closeshiftnow()"  class="btn btn-lg btn-info" style="font-weight:bold"><?=$lang_closeshif?> (<?php if(isset($_SESSION['shift_id'])){echo number_format($_SESSION['shift_id']);} ?>)</button>
				<?php } ?>
				</div>
...
<div class="form-group">
<button type="submit" 
ng-click="Addpushproductcode(product_code)" class="btn btn-default btn-lg" ng-disabled="yingbarcode">Enter</button>
</div>
...
<input type="text" onkeypress="validate(event)" ng-model="x.product_sale_num" 
ng-change="Updateproductnumber(x,$index)" style="width:50px;text-align:center;float:left;">
			<?php } ?>
...
<div class="modal fade" id="Showproduct_pointmodal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
<center><h1><?php echo $lang_sp_19;?> {{customer_score | number}}</h1></center>
	...
	<tbody>
		<tr ng-repeat="x in product_point_list">
			...
			<th><button  ng-if="x.point_use <= ParsefloatFunc(customer_score)" 
				...
				ng-click="Addpushproductcode(x.product_code,x)"><?php echo $lang_sp_21;?></button></th>
...
pregetlistcus()"  class="form-control" 
placeholder="<?php echo $lang_sp_42;?>" style="height: 45px;width: 300px;font-size: 20px;">
</div>
...
<div class="modal fade" id="Allcuscourse">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
<center><h1><b>{{cus_name_course}}</b></h1></center>
...
<div class="form-group">
			...
			<input  type="text" onkeypress="validate(event)" style="height:45px;font-size:25px;width:100px;" class="form-control" 
			ng-model="x.use_course" placeholder="<?php echo $lang_qty;?>">
		</div>
		<div class="form-group">
...
<table class="table table-hover table-bordered">
	<thead>
		<tr class="trheader">
			...
			<th><?=$lang_price?></th><th><?=$lang_discountperunit?></th>
		</tr>
	</thead>
	<tbody>
...
<table class="table table-hover table-bordered">
	...
	<tbody>
		<tr ng-repeat="x in listone">
			...
			{{(x.product_price - x.product_price_discount) * x.product_sale_num | number:<?php echo $_SESSION['decimal_print']; ?>}}</td>
		</tr>
		<tr>
...
?>
		...
		<tr ng-if="discount_last2 !='0.00'"><td align="right" colspan="7">
	<?php echo $lang_sp_60;?></td>
		<td  style="font-weight: bold;" align="right">-{{discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>
		<tr><td align="right" colspan="7"><?=$lang_sumall?></td>
		<td  style="font-weight: bold;" align="right"><u>{{sumsalevat-discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</u></td></tr>
		
		
		<tr ng-if="pay_type=='4'"><td align="right" colspan="7"><?=$lang_getmoney?></td>
		<td  style="font-weight: bold;" align="right">{{money_from_customer3 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>
...
?>
 <tr ng-if="vat3=='0'">
		...
		<td style="font-weight: bold;" align="right">
		{{((sumsalevat*100)/<?php echo $_SESSION['owner_vat']+100; ?>)*(<?php echo $_SESSION['owner_vat'];?>/100) | number}}</td>
		</tr>
		...
		<td align="right" colspan="7"><?=$lang_pricebeforvat?></td>
		<td style="font-weight: bold;" align="right">
		{{(sumsalevat*100)/<?php echo $_SESSION['owner_vat']+100; ?> | number}}</td>
		</tr>
...
?>
		...
		<tr ng-if="discount_last2 !='0.00'"><td align="right" colspan="7"><?=$lang_discount?></td>
		<td  style="font-weight: bold;" align="right">{{discount_last2 | number:<?php echo $_SESSION['decimal_print'];?>}}</td></tr>
		<tr><td align="right" colspan="7"><?=$lang_sumall?> _derrerererere</td>
		<td  style="font-weight: bold;" align="right"><u>{{sumsalevat-discount_last2 | number:<?php echo $_SESSION['decimal_print'];?>}}</u></td></tr>
...
<?=$lang_printbillshif?>	 <?php if(isset($_SESSION['shift_id_old'])){echo $_SESSION['shift_id_old'];} ?></button>
...
<br />
<input type="text" onkeypress="validate(event)" class="form-control" style="font-size:20px;font-weight:bold;height:50px;" ng-model="shift_money_start" 
placeholder="<?php echo $lang_startmoney;?>"/>
<br>
...
<br />
<input type="text" onkeypress="validate(event)" class="form-control" style="font-size:17px;font-weight:bold;height:50px;" ng-model="shift_money_end" 
...
<input type="number" class="form-control" style="font-size:20px;font-weight:bold;height:50px;" 
name="addshiftmoneystart" placeholder="x.xx"/>
<?php echo $lang_sp_78;?> <?php if(isset($_SESSION['shift_money_start'])){ echo number_format($_SESSION['shift_money_start'],2); } ?>
<br>
...
<?=$lang_billcloseshif?> <?php if(isset($_SESSION['shift_id_old'])){ echo $_SESSION['shift_id_old'];}?>
</h4>
...
<?=$lang_start?>: <?php if(isset($_SESSION['shift_start_time_old'])){ echo $_SESSION['shift_start_time_old'];}?>
<br />
<?=$lang_to?>: <?php if(isset($_SESSION['shift_end_time_old'])){ echo $_SESSION['shift_end_time_old'];}?>
<br />
<?php
...
<td align="right"  width="30px">{{x.product_price | number:0}}</td>
		...
		<td align="right">-{{discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>

		<tr ng-if="discount_last2!='0.00'">

		<td colspan="3"><?=$lang_sumall?></td>
		<td align="right" style="font-weight: bold;">{{sumsalevat-discount_last2 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>


		<tr>

		<td colspan="3"><?=$lang_getmoney?></td>
		<td align="right">{{money_from_customer3 | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>
		<tr>
	...
	<span ng-if="pay_type!='4'" style="font-weight: bold;"><?=$lang_moneychange?></span>
		...
		<td align="right">{{money_from_customer3 -(sumsalevat-discount_last2) | number:<?php echo $_SESSION['decimal_print']; ?>}}</td></tr>
...
<?php echo $lang_sp_99;?>
<textarea placeholder="<?php echo $lang_sp_99;?>" ng-show="showremark" ng-model="saleremark" 
...
<form class="form-inline">
<input type="number" id="popup_nummodal_focus" ng-model="popup_num_num" ng-change="Savepopup_num()" class="form-control" 
style="height: 100px;
    font-size: 100px;
	width: 100%;
    color: green;">
...
<div ng-repeat="x in pay_type_list" ng-if="x.pay_type_id!='4'">
	{{x.pay_type_name}}
	<input onkeypress="validate(event)" ng-model="x.pay_money" placeholder="{{x.pay_type_name}}" class="form-control" 
...
<textarea placeholder="<?php echo $lang_sp_109;?>" ng-if="showremark" ng-model="saleremark" 
class="form-control" style="height:200px;"></textarea>
<span ng-show="showremark">
<select ng-model="showremarkonslip">
<option value="0">
...
<form class="form-inline">
<input type="number" id="popup_pricemodal_focus" ng-model="popup_price_price" ng-change="Savepopup_price()" class="form-control" 
style="height: 100px;
    font-size: 100px;
	width: 100%;
    color: blue;">
...
<td><?=$lang_vat?> <?=$_SESSION['owner_vat']?> %</td>
		<td  style="font-weight: bold;" align="right">
		{{((sumsalevat*100)/<?php echo $_SESSION['owner_vat']+100; ?>)*(<?=$_SESSION['owner_vat']?>/100) | number}}</td>
		</tr>
...
<?php } ?>
		...
		<td></td>
		<td align="right">{{discount_last2 | number}}</td></tr>

		<tr>

		<td  style="text-align: left;"><?=$lang_sumall?></td>
		<td></td>
		<td align="right" style="font-weight: bold;">{{sumsalevat-discount_last2 | number}}</td></tr>
		...
		<td></td>
		<td align="right">{{money_from_customer3 | number}}</td></tr>

		<tr>

		<td  style="text-align: left;"><?=$lang_moneychange?></td>
		<td></td>
		<td align="right">{{money_from_customer3 -(sumsalevat-discount_last2) | number}}</td></tr>
...
class="form-control" style="width:300px;" placeholder="<?=$lang_search?> Runno, <?=$lang_cusname?>">
</div>
...
$('#morepay').modal({backdrop: "static", keyboard: false});
...
$scope.Showquotationlist = function(){
   ...
   $http.post("Salepage/getquotation",{
}).success(function(data){
...
if(response=='0'){window.location="<?php echo $base_url;?>";};
        });
};
