...
<center><h1><?php echo $lang_sprp_1;?></h1>
...
<?php if($_SESSION['user_type']=='4'){ ?>
<td align="right">{{x.product_pricebaseall | number:2}}</td>
<td align="right">{{x.product_priceall-x.product_pricebaseall | number:2}}</td>
<td align="center">{{((x.product_priceall-x.product_pricebaseall)*100)/x.product_pricebaseall | number:2}} %</td>
<?php } ?>
