	...
	<input type="checkbox" ng-model="showdeletcbut"> <?=$lang_showdel?>
            ...
            <table id="headerTable" class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr>
                        <td></td>
                        <td><input type="text" class="form-control" placeholder="<?php echo $lang_ssecr_4;?>"
                                ng-model="title_name"></td>
                        <td><input type="text" class="form-control" placeholder="<?php echo $lang_ssecr_5;?>"
                                ng-model="rate"></td>
                    ...
                    <tr ng-repeat="x in categorylist">
                        ...
                        <td ng-show="e_id!=x.e_id">
                            ...
                            <button class="btn btn-xs btn-warning"
                                ng-click="Editinputcategory(x.e_id)"><?=$lang_edit?></button>
                            <button ng-show="showdeletcbut" class="btn btn-xs btn-danger"
                                ng-click="Deletecategory(x.e_id)">
                                <?=$lang_delete?></button>
                        </td>
                        ...
                        <td ng-show="e_id==x.e_id">
                            ...
                            <button class="btn btn-xs btn-success"
                                ng-click="Editsavecategory(x.e_id,x.title_name,x.rate)">
                                <?=$lang_save?></button>
                            <button class="btn btn-xs btn-default"
                                ng-click="Cancelcategory(x.e_id)"><?=$lang_cancel?></button>
                        </td>
