...
<table id="headerTable" class="table table-hover table-bordered">
	<thead>
		<tr style="background-color: #eee;">
			<th style="text-align: center;"><?php echo $lang_ssntp_1;?></th>
			<th style="text-align: center;"> <?php echo $lang_ssntp_2;?></th>
			<th style="text-align: center;"> <?php echo $lang_ssntp_3;?></th>
			<th style="text-align: center;"><?php echo $lang_ssntp_4;?></th>
			
		</tr>
	</thead>
	<tbody>
		<tr ng-show="productliststep.length=='0'">
			<td><input type="text" ng-model="num" class="form-control"></td>
			<td align="right"><input type="text" ng-model="price" class="form-control"></td>
<td><input type="text" ng-model="remark" class="form-control"></td>
		...
		<tr ng-repeat="x in productliststep">
			<td align="center">{{x.num | number:2}}</td>
			<td align="right">{{x.price | number:2}}</td>
...
$http.post("numtoprice/getproductstep",{
...
$http.post("numtoprice/saveprice",{
...
$http.post("numtoprice/deleteprice",{
	'id': x.id
	}).success(function(data){
