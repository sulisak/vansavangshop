        ...
        <div class="panel-body">
            ...
            <table id="headerTable" class="table table-hover table-bordered">
                ...
                <tbody>
                    <tr>
                        <td></td>
                        <td><input type="text" class="form-control" placeholder="<?php echo $lang_sspt_1;?>"
                                ng-model="pay_type_name"></td>
                        <td><button class="btn btn-success"
                                ng-click="Savecategory(pay_type_name)"><?=$lang_save?></button></td>
                    </tr>
                    ...
                    <tr ng-repeat="x in categorylist">
                        ...
                        <td ng-show="pay_type_id==x.pay_type_id"><input type="text" ng-model="x.pay_type_name"
                        ...
                        <td ng-show="pay_type_id!=x.pay_type_id">
                            ...
                            <button class="btn btn-xs btn-warning"
                                ng-click="Editinputcategory(x.pay_type_id)"><?=$lang_edit?></button>
                            <button ng-show="showdeletcbut && x.pay_type_id>'5'" class="btn btn-xs btn-danger"
                                ng-click="Deletecategory(x.pay_type_id)">
                                <?=$lang_delete?></button>
                        </td>
                        ...
                        <td ng-show="pay_type_id==x.pay_type_id">
                            ...
                            <button class="btn btn-xs btn-success"
                                ng-click="Editsavecategory(x.pay_type_id,x.pay_type_name)">
                                <?=$lang_save?></button>
                            <button class="btn btn-xs btn-default"
                                ng-click="Cancelcategory(x.pay_type_id)"><?=$lang_cancel?></button>
                        </td>
