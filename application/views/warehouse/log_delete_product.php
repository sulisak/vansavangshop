...
<th class="text-center"><?php echo $lang_ldp_2;?></th>
			<th class="text-center"><?php echo $lang_ldp_3;?></th>
			<th class="text-center"><?php echo $lang_ldp_4;?></th>
			<th class="text-center"><?php echo $lang_ldp_5;?></th>
<th class="text-center"><?php echo $lang_ldp_6;?></th>
...
//    }
 ...
 if(!perpage){
   ...
   $http.post("log_delete_product/get",{
