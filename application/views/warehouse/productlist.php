...
<span style="font-family: Phetsarath OT !important;">
                            ...
                            <tr ng-repeat="x in list">
                                ...
                                <td align="center">
                                    <span ng-if="x.product_image!=''">
                                        <center>
                                            <img ng-src="<?php echo $base_url;?>/{{x.product_image}}" width="70px"
                                                height="70px;">
                                            <br />
                                ...
                                <td>
                                    ...
                                    <br />
                                    <button ng-click="Opensn(x)" class="btn btn-default btn-xs"
                                        ng-if="x.csn>'0'">{{x.csn}}
                                        SN</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                    ...
                                    <tr ng-repeat="x in getpotlist">
                                        ...
                                        <td>
                                            <select class="form-control" ng-if="x.product_num_relation"
                                                ng-model="x.product_type_relation"
                                                ng-init="x.product_type_relation='0'">
                                ...
                                <hr />
                                <?=$lang_productrelat?>/ສ່ວນປະກອບ {{potdata.product_name}} 1
                                {{potdata.product_unit_name}}
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <?=$lang_productname?>
                                <input type="text" ng-model="product_name_sizecolor"
                                    placeholder="<?=$lang_productname?>" class="form-control">
                                <p></p>
                                ...
                                <button ng-click="Addproductsizecolor()"
                                    class="btn btn-success"><?=$lang_save?></button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="Updatedata" enctype="multipart/form-data" method="POST">
                                    ...
                                    <?=$lang_barcode?>
                                    <input type="text" onkeypress="validate(event)" name="product_code"
                                        id="product_code" placeholder="<?=$lang_barcode?>" class="form-control">
                                    <p></p>
                                    ...
                                    <?=$lang_productname?>
                                    <input type="text" onkeypress="validate_pn(event)" name="product_name"
                                        id="product_name" placeholder="<?=$lang_productname?>" class="form-control"
                                        required="required">
                                    <p></p>
                                    ...
                                    <?php }else{ ?>
                                    <input type="hidden" id="is_course" name="is_course"
                                        class="form-control text-right">
                                    <?php } ?>
...
app.controller('Index', function($scope, $http, $location) {
    ...
    //     $http.get('salesetting/exchangerate/get')
    //         .then(function(response) {
    //             $scope.categorylist = response.data.list;
