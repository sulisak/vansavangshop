...
<table id="headerTable" class="table table-hover table-bordered">
	<thead>
		<tr class="trheader">
			...
			<th class="text-center"><?php echo $lang_rns_2;?></th>
	...
	<td style="text-align:center;">
			...
			<td  class="text-center">{{Funcnull(x.product_out_num)+Funcnull(x.product_saleout_num) | number}}</td>
